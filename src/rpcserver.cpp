...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Redux features */
        {"redux", "masternode", &masternode, true, true, false},
        {"redux", "listmasternodes", &listmasternodes, true, true, false},
        {"redux", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"redux", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"redux", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"redux", "getmasternodecount", &getmasternodecount, true, true, false},
        {"redux", "masternodeconnect", &masternodeconnect, true, true, false},
        {"redux", "masternodecurrent", &masternodecurrent, true, true, false},
        {"redux", "masternodedebug", &masternodedebug, true, true, false},
        {"redux", "startmasternode", &startmasternode, true, true, false},
        {"redux", "createmasternodekey", &createmasternodekey, true, true, false},
        {"redux", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"redux", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"redux", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"redux", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"redux", "getmasternodescores", &getmasternodescores, true, true, false},
        {"redux", "mnbudget", &mnbudget, true, true, false},
        {"redux", "preparebudget", &preparebudget, true, true, false},
        {"redux", "submitbudget", &submitbudget, true, true, false},
        {"redux", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"redux", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"redux", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"redux", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"redux", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"redux", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"redux", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"redux", "checkbudgets", &checkbudgets, true, true, false},
        {"redux", "mnsync", &mnsync, true, true, false},
        {"redux", "spork", &spork, true, true, false},
        {"redux", "getpoolinfo", &getpoolinfo, true, true, false},
        {"redux", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"wallet", "walletpassreduxasechange", &walletpassreduxasechange, true, false, true},
        {"wallet", "walletpassreduxase", &walletpassreduxase, true, false, true},
        ...
        {"zerocoin", "getzreduxseed", &getzreduxseed, false, false, true},
        {"zerocoin", "setzreduxseed", &setzreduxseed, false, false, true}
...
{
    return "> redux-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16611/\n";
}
