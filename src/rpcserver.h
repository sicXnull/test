...
extern std::string HelpRequiringPassreduxase();
...
extern UniValue walletpassreduxase(const UniValue& params, bool fHelp);
extern UniValue walletpassreduxasechange(const UniValue& params, bool fHelp);
...
extern UniValue setzreduxseed(const UniValue& params, bool fHelp);
extern UniValue getzreduxseed(const UniValue& params, bool fHelp);
