...
public:
    ...
    bool WriteZREDUXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZREDUXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZREDUXSeed_deprecated(uint256& seed);
    bool EraseZREDUXSeed();
    bool EraseZREDUXSeed_deprecated();

    bool WriteZREDUXCount(const uint32_t& nCount);
    bool ReadZREDUXCount(uint32_t& nCount);
