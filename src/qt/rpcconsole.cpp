                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzreduxPathCustom = GetArg("-zreduxbackuppath", "");
    ...
    if(!strzreduxPathCustom.empty()) {
        ui->wallet_customzreduxbackuppath->setText(QString::fromStdString(strzreduxPathCustom));
        ui->wallet_customzreduxbackuppath_label->setVisible(true);
        ui->wallet_customzreduxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzreduxPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Redux RPC console.") + "<br>" +
