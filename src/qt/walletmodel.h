...
public:
    ...
    // Wallet encryption
    bool setWalletEncrypted(bool encrypted, const SecureString& passreduxase);
    // Passreduxase only needed when unlocking
    bool setWalletLocked(bool locked, const SecureString& passPhrase = SecureString(), bool anonymizeOnly = false);
    bool changePassreduxase(const SecureString& oldPass, const SecureString& newPass);
