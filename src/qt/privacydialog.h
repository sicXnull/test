...
public:
    ...
    void setZReduxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzREDUX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzREDUX_clicked();
    void on_pushButtonZReduxControl_clicked();
