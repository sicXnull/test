...
/* AskPassreduxaseDialog -- Maximum passreduxase length */
static const int MAX_PASSREDUXASE_SIZE = 1024;

/* Redux GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Redux"
#define QAPP_ORG_DOMAIN "redux.org"
#define QAPP_APP_NAME_DEFAULT "Redux-Qt"
#define QAPP_APP_NAME_TESTNET "Redux-Qt-testnet"
