...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    if (walletModel) {
        ...
        // Ask for passreduxase if needed
...
void WalletView::encryptWallet(bool status)
{
    if (!walletModel)
        return;
    AskPassreduxaseDialog dlg(status ? AskPassreduxaseDialog::Encrypt : AskPassreduxaseDialog::Decrypt, this, walletModel);
    dlg.exec();
...
void WalletView::changePassreduxase()
{
    AskPassreduxaseDialog dlg(AskPassreduxaseDialog::ChangePass, this, walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet()
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPassreduxaseDialog dlg(AskPassreduxaseDialog::UnlockAnonymize, this, walletModel);
        dlg.exec();
    }
}
