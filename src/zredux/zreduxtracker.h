...
#ifndef REDUX_ZPIVTRACKER_H
#define REDUX_ZPIVTRACKER_H
...
public:
    CzREDUXTracker(std::string strWalletFile);
    ~CzREDUXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzREDUXWallet* zREDUXWallet = NULL);
