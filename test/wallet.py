...
#   c) node1 mines 32 blocks, so now node 0 has 60001redux, node 1 has 4250redux, node2 has none.
#   d) node0 sends 601 redux to node2, in two transactions (301 redux, then 300 redux).
