Contributing to Redux Core
============================

The Redux Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Redux Core project, and is not to be
confused with overall Redux Network Protocol consensus changes.

Whether a pull request is merged into Redux Core rests with the project merge
...
Patches that change Redux consensus rules are considerably more involved than
...
Where a patch set proposes to change the Redux consensus, it must have been
...
The project leader is the release manager for each Redux Core release.
