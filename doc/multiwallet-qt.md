...
In order to support loading of multiple wallets in redux-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is redux.cpp.
...
Changes to redux.cpp
----------------------
redux.cpp is the entry point into redux-qt, and as such, will require some minor modifications to provide hooks for
