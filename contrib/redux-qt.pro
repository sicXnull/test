...
HEADERS += src/activemasternode.h \
           ...
           src/qt/askpassreduxasedialog.h \
...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpassreduxasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpassreduxasedialog.cpp \
...
RESOURCES += src/qt/redux.qrc src/qt/redux_locale.qrc

TRANSLATIONS += src/qt/locale/redux_bg.ts \
                src/qt/locale/redux_de.ts \
                src/qt/locale/redux_en.ts \
                src/qt/locale/redux_es.ts \
                src/qt/locale/redux_fi.ts \
                src/qt/locale/redux_fr.ts \
                src/qt/locale/redux_it.ts \
                src/qt/locale/redux_ja.ts \
                src/qt/locale/redux_pl.ts \
                src/qt/locale/redux_pt.ts \
                src/qt/locale/redux_ru.ts \
                src/qt/locale/redux_sk.ts \
                src/qt/locale/redux_sv.ts \
                src/qt/locale/redux_vi.ts \
                src/qt/locale/redux_zh_CN.ts \
                src/qt/locale/redux_zh_TW.ts
