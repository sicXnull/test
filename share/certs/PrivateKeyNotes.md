...
The key and certificate is in a separate, passreduxase-protected keychain file that is
...
The key and certificate were exported into a separate, passreduxase-protected PKCS#12 file, and
...
install a keylogger to get the passreduxase that protects them.
